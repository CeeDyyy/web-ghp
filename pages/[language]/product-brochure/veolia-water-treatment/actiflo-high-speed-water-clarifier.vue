  ...
  <NuxtLayout>
    ...
    <div class="d-flex justify-center mb-4">
      <iframe
        width="840"
        height="472.5"
        src="https://www.youtube.com/embed/m54tYlzDKO0"
...
import ActifloHighSpeedWaterClarifier from "/assets/product-brochure/veolia-water-treatment/actiflo-high-speed-water-clarifier.json";
...
export default {
  ...
  data() {
    return {
      info: ActifloHighSpeedWaterClarifier.EN,
      Data: ActifloHighSpeedWaterClarifier,
